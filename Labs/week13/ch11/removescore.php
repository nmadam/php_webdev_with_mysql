...
<body>
    ...
    <!--This remove.php is set up with conditions of both the GET and POST
            since there is a SELF REFERENCING form used for confirmation!-->

<?php
    require_once('appvars.php');
    require_once('connectvars.php');
  
    //If all are set assign variables
    ...
    }//if remove score on different page can call the action using post 
    ...
    if (isset($_POST['submit'])) {
        ...
        echo '<p><strong>Name: </strong>' . $name . '<br /><strong>Date: </strong>' . 
                $date . '<br /><strong>Score: </strong>' . $score . '</p>';
