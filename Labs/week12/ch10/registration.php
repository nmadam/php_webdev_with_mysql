...
<?php
    ...
    // Insert data into the RiskyJobs database
    require_once('connectvars.php');
    
    $dbc = mysqli_connect(DB_HOST, DB_USER, DB_PASSWORD, DB_NAME)
                or die('Error connecting to MySQL server.');
    
    $queryInsert = "INSERT INTO riskyjobs (firstname, lastname, email, phone, job, resume)" . 
                "VALUES ('$first_name', '$last_name', '$email', '$new_phone', '$job', '$resume')";
